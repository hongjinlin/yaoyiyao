...
<script>
	...
	<div class="diywap_right">
		...
		<?php if($chance != 100): ?><p><font color="red">“获奖概率”总合应为 "100"，现为 "<?php echo ($chance); ?> ",请修改!</font></p><?php endif; ?>
		<table class="table table-hover table-bordered">
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="active">
					<td><?php echo ($i); ?></td>
					<td><?php echo ($vo["prizename"]); ?></td>
					<td width="100px"><?php echo ($vo["prizecontent"]); ?></td>
					<td width="100px"><?php echo ($vo["prizenum"]); ?></td>
                    <td width="100px"><?php echo ($vo["chance"]); ?></td>
					
					
					<td><a href="__APP__/Goods/doDel/id/<?php echo ($vo["id"]); ?>" onclick='return del();'>删除</a>|<a href="__APP__/Goods/modifyGoods/id/<?php echo ($vo["id"]); ?>">修改</a></td>

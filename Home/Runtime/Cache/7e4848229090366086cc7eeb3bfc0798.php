        ...
        if (!shaking && !stop) {
            ...
            if (!hasSend) {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "HAjax.aspx?id=61&t=rvmb8uisn585l989&action=yyy&o=oWUSptx-cdAQW3c2LDCeEsTgBURHY&tid=5&sd="+Math.random(),                  
                  ...
                  error: function(XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    success: function (data) {
                        ...
                        if (data.success == false && data.hasGet==true) {
...
<div class="wap">
    ...
    <div class="game-btn" style="z-index: 9999;position: relative;">
        ...
        <div class="game-last-time">
         <div style="margin-bottom:5px;">您今天已经摇奖<span class="game-last-times font-ffd700">0</span>次，每天最多有<span class="game-last-times font-ffd700">5</span>次摇奖机会</div>
    ...
    <div class="game-box page-descs">
        ...
        <li class="clearfix">
		<span class="prize-name">一元话费</span>
		<span class="prize-num">￥1</span>
		</li>
		
		<li class="clearfix">
		<span class="prize-name">二元话费</span>
		<span class="prize-num">￥2</span>
		</li>
		
		<li class="clearfix">
		<span class="prize-name">三元话费</span>
		<span class="prize-num">￥3</span>
		</li>
		
		<li class="clearfix">
		<span class="prize-name">五元话费</span>
		<span class="prize-num">￥5</span>
		</li>
		
		<li class="clearfix">
		<span class="prize-name">谢谢参与</span>
		<span class="prize-num">￥0</span>
		</li>

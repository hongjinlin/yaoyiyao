...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/Css/shake.css" />
...
<div class="wap">
    ...
    <div class="wrapper" id="result" style="display:none; z-index:100;">
		...
		<img class="bg" src="__PUBLIC__/Images/info_bg.jpg" />
...
<audio id="audio1" src="__PUBLIC__/Css/shake_sound_male.mp3" preload="auto">
</audio>
<audio id="audio2" src="__PUBLIC__/Css/shake_match.mp3" preload="auto">
</audio>
<audio id="audio3" src="__PUBLIC__/Css/shake_fail.mp3" preload="auto">
</audio>
	

	<div id="loading" class="loading-mask">
		<img class="gimg" src="__PUBLIC__/Images/ajax-loader.gif">
	</div>
	<script type="text/javascript">
	    $(function () {
